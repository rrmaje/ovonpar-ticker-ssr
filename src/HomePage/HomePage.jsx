    ...
    render() {
        ...
        return (
            <div>
                ...
                <p><strong>Stock Ticker supports single session only in the current version. Market Reporting and Best Bid Offers are for the current session. Sessions start 8.00AM CET and end 4.00PM CET Monday through Friday.</strong></p>
